...
class _ChatHomePageState extends State<ChatHomePage> {
  late ChatThread _selectedThread = widget.repository.threads.first;
  ...
  Widget _buildConversation({required bool showBackButton}) {
    return _ConversationPane(
      ...
      localMessages: _localMessages
          .where((message) => message.threadId == _selectedThread.id)
          .toList(),
  ...
  List<ChatThread> get _filteredThreads {
    ...
    if (normalizedQuery.isEmpty) {
      return widget.repository.threads;
    }

    return widget.repository.threads.where((thread) {
